...
export const PomodoroTimer = () => {
  ...
  const [timeLeft, setTimeLeft] = useState(25 * 60); // 25 minut
      ...
      interval = setInterval(() => {
        setTimeLeft((prev) => {
          if (prev <= 1) {
            ...
            playAlarm();
            toast({
              title: "Pomodoro dokončeno!",
              description: "Čas na přestávku.",
              duration: 5000,
            });
            return 25 * 60;
          }
  ...
  return (
    <Card className="fixed bottom-20 right-6 p-4 bg-card/95 backdrop-blur border-white/10 shadow-lg z-50 animate-fade-in">
      <div className="flex flex-col items-center gap-4">
        ...
        <div className="flex gap-2">
          <Button onClick={toggleTimer} className="bg-primary hover:bg-primary/90">
